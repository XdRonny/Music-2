...
class Config(object):
    ...
    BLACK_IMG = getenv("BLACK_IMG", "https://te.legra.ph/file/daba9d67612e1c1fb84ad.jpg")        # black image for progress
    BOT_NAME = getenv("BOT_NAME", "\x40\x4d\x75\x73\x69\x63\x5f\x48\x65\x6c\x6c\x42\x6f\x74")   # dont put fancy texts here.
    BOT_PIC = getenv("BOT_PIC", "https://te.legra.ph/file/95889a82500367a24fb4e.jpg")           # put direct link to image here
